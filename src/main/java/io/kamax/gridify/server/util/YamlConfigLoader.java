...
public class YamlConfigLoader {
    ...
    public static GridifyConfig loadFromFile(String path) throws IOException {
        String data = IOUtils.toString(new FileInputStream(path), StandardCharsets.UTF_8);
        Object o = load(data, GridifyConfig.class);
        return GsonUtil.get().fromJson(GsonUtil.get().toJson(o), GridifyConfig.class);
    }

    public static Optional<GridifyConfig> tryLoadFromFile(String path) {
        try {
