...
import io.kamax.gridify.server.core.identity.ThreePidLookup;
import io.kamax.gridify.server.core.identity.User;
import io.kamax.gridify.server.network.matrix.core.MatrixIdentityServer;
...
public class BaseMatrixIdentityServer implements MatrixIdentityServer {
    ...
    public BaseMatrixIdentityServer(GridifyServer g) {
        this.g = g;
    }
