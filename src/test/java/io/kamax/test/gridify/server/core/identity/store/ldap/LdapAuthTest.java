...
package io.kamax.test.gridify.server.core.identity.store.ldap;
...
import io.kamax.gridify.server.config.Identity.store.LdapConfig;
import io.kamax.gridify.server.core.GridType;
import io.kamax.gridify.server.core.auth.AuthResult;
import io.kamax.gridify.server.core.identity.store.ldap.LdapIdentityStore;
